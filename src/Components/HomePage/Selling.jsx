...
const Selling = () => {
  const itemsPerPage = 4; // Number of items to display per view
  ...
  return (
    <div className="best-selling-container">
      <h2 className="selling-title"><span className="ul">Our</span> Best Selling Product</h2>
          ...
          {currentItems.map((product) => (
            <Col key={product.id} md={3} sm={6} xs={12} className="Selling-col">
              <Card className="Selling-card">
                <Card.Img variant="top" src={product.imageUrl} className="Selling-image" />
                <Card.Body>
                  <Card.Title className="Selling-title">{product.name}</Card.Title>
                  <Card.Subtitle className="Selling-subtitle">{product.subtitle}</Card.Subtitle>
                  <div className="Selling-price-container">
                    <span className="Selling-price">{product.price}</span>
                    <span className="Selling-original-price">{product.originalPrice}</span>
